...
static char* ger_text[] = {
    ...
    "%d Augen",
    "Überreizt !",
    "Gegner nicht Schneider !",
    "Gegner nicht schwarz !",
    "Eine Jungfrau !",
    "Durchmarsch !",
    "Niemand",
    "gewinnt",
    ...
    " Spielwert verdoppelt ",
    "nimmt den Skat nicht auf.",
    "klopft !",
    "VH schob:",
    "MH schob:",
    "HH schob:",
    ...
    " Grand Hand ? ",
    "   Bock-Spiel   ",
    "Verloren mit 60 Augen",
    "Grand Hand gewonnen",
    "Erfolgreicher Kontra",
    "Kontra & Re angesagt",
    "NNN Punkte in Spielliste",
    "N00 Punkte in Spielliste",
    "Spielwert ist >= +72",
    "Spielwert ist >= +96",
    " Benutzeroberfläche ",
    "Tastatur",
    ...
    "Karten aufdecken ?",
    "Revolution",
    "Revolution: Karten austauschen !",
    "Vorhand",
    "Mittelhand",
    "Hinterhand",
    "Klopfen",
    " Klopfen ",
    "Spielwert verdoppeln ?",
    "Schenken",
    " Schenken ",
    ...
    "English",
    "Alte Regeln",
    "Ein Maus-Klick oder ESC / F1",
    "bringt dieses Menü zur Anzeige",
    " Mehrspieler-Modus ",
...
static char* eng_text[] = {
    ...
    "%d points",
    "Overbid !",
    "Opponents not Schneider !",
    "Opponents not schwarz !",
    "One virgin !",
    "Forced march !",
    "Nobody",
    "wins",
    ...
    "   Bock game   ",
    "Lost with 60 points",
    "Successful Grand Hand",
    "Successful Kontra",
    "Kontra & Re game",
    "NNN points in game list",
    "N00 points in game list",
    "Game value is >= +72",
    "Game value is >= +96",
    " User interface ",
    "Keyboard",
