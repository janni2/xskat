...
enum {
  ...
  TX_DEN_RAMSCH,
  TX_DAS_NULLSPIEL,
  TX_DAS_SPIEL_SCHWARZ,
  TX_MIT_N_ZU_M_AUGEN,
  TX_HAND_F,
  TX_SPIEL_BEENDEN,
  TX_SPIELENDE,
  TX_BEENDET_DAS_SPIEL,
  TX_AHA,
  TX_LOESCHEN_F,
  TX_SPIEL,
  TX_SCHNEIDER,
  ...
  TX_UND_RAMSCH,
  TX_FORTSETZEN,
  TX_BOCK_EREIGNISSE_T,
  TX_BOCK_EREIGNIS,
  TX_N_BOCK_EREIGNISSE,
  TX_BOCK_SPIELE,
  TX_GRAND_HAND,
  TX_BOCK_SPIEL,
  TX_VERLOREN_MIT_60,
  TX_GRAND_HAND_GEWONNEN,
  TX_ERFOLGREICHER_KONTRA,
  TX_KONTRA_RE_ANGESAGT,
  TX_NNN_IN_SPIELLISTE,
  TX_N00_IN_SPIELLISTE,
  TX_SPIELWERT_72,
  TX_SPIELWERT_96,
  TX_BENUTZEROBERFLAECHE,
  TX_TASTATUR,
  TX_MENU_BUTTON,
  TX_JEDER,
  TX_WENIG_HINWEISE,
  ...
  TX_KARTEN_AUFDECKEN,
  TX_REVOLUTION,
  TX_KARTEN_AUSTAUSCHEN,
  TX_VORHAND,
  TX_MITTELHAND,
  TX_HINTERHAND,
  TX_KLOPFEN,
  TX_KLOPFEN_T,
  TX_SPIELWERT_VERDOPPELN,
  TX_SCHENKEN,
  TX_SCHENKEN_T,
  TX_SPIEL_VERLOREN_GEBEN,
  TX_GESCHENK_ANNEHMEN,
  TX_MITSPIELER_LEHNT_AB,
  TX_GEGNER_GEBEN_AUF,
  TX_AKZEPTIERT,
  TX_GEBEN,
  TX_SCHNELL,
